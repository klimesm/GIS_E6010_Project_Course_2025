...
- Apply trained model to large-area HPMF/indices (~3000 km²).
- Generate ditch probability maps.
- (Optional) Convert results to vector format for GIS/hydrological modeling.

---

### Embedding Notes
- This Markdown expects **ditch_workflow_flowchart.svg** to be in the **same folder** as the `.md` file for the image to render.
